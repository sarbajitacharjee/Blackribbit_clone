...
const RapidDiagnostic = () => {
  ...
  const examples = [
    {
      ...
      image:
        "https://blackribbit.com/wp-content/uploads/2025/08/cMRI_calculator-1.jpg",
    },
    {
      title: "LAPD online Diagnostic",
      image:
        "https://blackribbit.com/wp-content/uploads/2025/08/rbd_example_cover-1.jpg",
    },
    {
      title: "Website Scorecard",
      image:
        "https://blackribbit.com/wp-content/uploads/2025/08/website-scorecard-1.jpg",
    },
  ];
  ...
  useEffect(() => {
    ...
    updateTime();
    const interval = setInterval(updateTime, 60000); // updates every 1 minute
  ...
  return (
    <>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="flex justify-center items-center max-w-5xl md:px-10 ">
            ...
            <p className="text-md md:text-2xl md:ml-60 ml-10 leading-relaxed max-w-3xl">
              Get a comprehensive assessment of your culture-brand alignment
              with specific recommendations for transformation.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-black">
            ...
            <div className="bg-[#FCBB53] p-6 rounded-2xl shadow-md">
              ...
              <p className="text-sm text-start">
                Understanding the monetary implications of any gaps in employee
                engagement through comprehensive data analysis and benchmarking.
              </p>
            </div>
            ...
            <div className="bg-[#FCBB53] p-6 rounded-2xl shadow-md">
              ...
              <p className="text-sm text-start">
                Complete evaluation of your digital presence from social media
                to reviews and articles, measuring public sentiment and brand
                consistency.
              </p>
            </div>
            ...
            <div className="bg-[#FCBB53] p-6 rounded-2xl shadow-md">
              ...
              <p className="text-sm text-start">
                Comprehensive analysis of your website’s messaging and visual
                design, scored against culture-brand alignment principles.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#292929] text-white py-12 px-4">
      ...
      <section className="bg-white text-gray-800 px-6 py-16">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#FC9C04] text-black rounded-xl p-6 shadow-md">
              ...
              <p className="text-sm md:text-base leading-relaxed">
                Most companies operate with blind spots about how their internal
                culture translates to external perception. This diagnostic
                reveals exactly where disconnects exist and what they’re costing
                you.
              </p>
            </div>
            ...
            <div className="bg-[#FC9C04] text-black rounded-xl p-6 shadow-md">
              ...
              <p className="text-sm md:text-base leading-relaxed">
                The assessment includes quantified analysis of how culture gaps
                affect your bottom line—from recruitment costs to customer
            ...
            <div className="bg-[#FC9C04] text-black rounded-xl p-6 shadow-md">
              ...
              <p className="text-sm md:text-base leading-relaxed">
                You receive specific, prioritized steps for closing any gaps we
                identify, whether that’s through our full Culture Branding
                Program or independent initiatives.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl text-start md:text-3xl font-semibold mb-10 text-gray-700">
            How It Works
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6  border border-gray-700 rounded-lg p-8">
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-600">
                30-minute diagnostic planning session to understand your
                situation and gather necessary access information.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-600">
                Our team conducts comprehensive evaluation across all three
                diagnostic components using proprietary frameworks.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-600">
                In 24 hours, receive your complete diagnostic report with
                specific recommendations for transformation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white text-gray-800 px-6 py-16">
        <div className="max-w-5xl mx-auto relative">
          ...
          <p className="text-gray-900 mb-10 text-sm md:text-base">
            Ready to understand exactly where your culture and brand align—and
            where they don’t? Schedule your diagnostic planning session and
            receive your complete assessment in 24 hours.
          </p>
          ...
          >
            {/* Ribbon */}
            <div className="absolute top-36 right-0 bg-gray-800 text-white text-xs font-semibold px-3 py-1 rounded-bl-lg rounded-tr-xl">
              Powered by Calendy
            </div>
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4 text-gray-700">
                <button className="text-xl font-semibold hover:text-orange-500">
                  &lt;
                </button>
              ...
              {/* Dates */}
              <div className="grid grid-cols-7 md:h-80 gap-2 text-sm md:text-base">
              ...
              <h1>Time zone</h1>
              <div className="flex items-center justify-start md:justify-start mt-4 text-sm text-gray-700">
                <FaGlobeAsia className="mr-2 text-gray-800" />
            ...
            <AnimatePresence>
              {selectedDate && (
                ...
                >
                  ...
                  <div className="flex flex-col  md:mt-16  gap-3">
        ...
        <div className="max-w-6xl mx-auto mt-16 border border-gray-400 rounded-lg p-6 bg-white">
          ...
          <p className="text-sm md:text-lg text-gray-600 leading-relaxed">
            A minimum of 1-year online presence is required for comprehensive
            online diagnostic. Companies with limited digital presence can still
            access the full Culture Branding Program and cMRI calculator.
          </p>
        </div>
      </section>
    </>
